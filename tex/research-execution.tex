...
\begin{figure}[htbp!]
	...
	\caption{Example of a sketch made by the experimenters. \added{The researchers have used drafts like this to progress in the definition of the experimental process workflow described in Section~\ref{sec-results:process-workflow}.}}
